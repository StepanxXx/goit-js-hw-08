...
function onGalleryContainerClick(event) {
  ...
  const originalDescription = event.target.dataset.description;
  openModal(originalImageURL, originalDescription);
}

function openModal(imageURL, description) {
  const instance = basicLightbox.create(`
    <img src="${imageURL}" alt="${description}" width="1112" height="640">
  `);
